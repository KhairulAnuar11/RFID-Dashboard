            ...
            <div key={device.id} className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 font-mono">{device.macAddress}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-900">{device.signalStrength}%</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-gray-900">{device.tagsReadToday}</span>
                </div>
                <div className="flex justify-between">
